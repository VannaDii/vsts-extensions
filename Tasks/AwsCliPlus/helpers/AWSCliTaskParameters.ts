...
export class TaskParameters extends sdkutils.AWSTaskParametersBase {
    ...
    constructor() {
        ...
        try {
            ...
            this.isOutputParsingEnabled = (this.variableName != null && this.variableName.length > 0 &&
                                           this.regularExpression != null && this.regularExpression.length > 0);
            ...
            this.isPollingEnabled = (this.pollingIntervalMinutes > 0 &&
                                     this.pollingMaxAttempts > 0 &&
                                     this.pollingRegularExpression != null && this.pollingRegularExpression.length > 0);
        } catch (error) {
