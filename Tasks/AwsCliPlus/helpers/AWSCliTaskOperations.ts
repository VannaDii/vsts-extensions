...
export class TaskOperations {
    ...
    public static async executeCommand(taskParameters: Parameters.TaskParameters) : Promise<string> {
        ...
        try {
            ...
            awsCliTool.on('stdline', (data) => {
                returnValue += (<string>data) + '\n';
            });

            const code: number = await awsCliTool.exec(<tr.IExecOptions>{
                failOnStdErr: taskParameters.failOnStandardError,
